...
test("resolveViewerSnapIndex advances on a committed drag or a fast swipe", () => {
    assert.equal(resolveViewerSnapIndex(1, -180, 0, 360, 6), 2);
    assert.equal(resolveViewerSnapIndex(1, -24, -0.75, 360, 6), 2);
    assert.equal(resolveViewerSnapIndex(1, 180, 0, 360, 6), 0);
});

test("resolveViewerSnapIndex clamps at the first and last slides", () => {
    assert.equal(resolveViewerSnapIndex(0, 240, 0, 360, 6), 0);
    assert.equal(resolveViewerSnapIndex(5, -240, 0, 360, 6), 5);
});
